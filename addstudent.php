			...
			<section role="main" class="content-body transition-fade" id="swup">
				...
				<section class="panel">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							<label class="col-md-3 control-label">Дата народження:<span
						...
						<div class="form-group">
							<label class="col-md-3 control-label">Місце народження:<span
									style="color: red;">*</span></label>
							<div class="col-md-8">
						...
						<div class="form-group">
							<label class="col-md-3 control-label">Адрес місця проживання:<span
									style="color: red;">*</span></label>
							<div class="col-md-8">
						...
						<div class="form-group">
							<label class="col-md-3 control-label">Зарахований(на) наказом від:<span
									style="color: red;">*</span></label>
							<div class="col-md-8">

								<input type="text" class="form-control" value="<?= $reckoned ?>" id="reckoned"
									placeholder='"____"_______" 20__ року №__ '>

							</div>
						</div>
						<div class="form-group">
							<label class="col-md-3 control-label" for="inputDefault">Група:<span
									style="color: red;">*</span></label>
							<div class="col-md-8">
								<?php
								...
								while ($row = $Student7->fetch_assoc()) {
									...
									?>
									<input type="text" class="idgruop form-control" id="idsel" value="<?= $row["name"] ?>"
										readonly>
									<?php
								}
								?>
						...
						<div class="form-group">
							<label class="col-md-3 control-label">Початок навчання:<span
									style="color: red;">*</span></label>
							<div class="col-md-8">
								<div class="input-group">
									<span class="input-group-addon">
									...
									<input type="date" class="form-control" value="<?= $Start_learning ?>"
										id="Start_learning" placeholder='"____"_______" 20__ року '>
								</div>
							</div>
						</div>

						<div class="form-group">
							<label class="col-md-3 control-label">Закінчення навчання:<span
									style="color: red;">*</span></label>
							<div class="col-md-8">
								<div class="input-group">
									<span class="input-group-addon">
									...
									<input type="date" class="form-control" value="<?= $graduation ?>" id="graduation"
										placeholder='"____"_______" 20__ року '>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<label class="col-md-3 control-label">Форма навчання<span
									style="color: red;">*</span></label>
							<div class="col-md-8">
								<div class="input-group">
						...
						<div class="form-group">
							<label class="col-md-3 control-label">Освітньо-професійний ступінь:<span
									style="color: red;">*</span></label>
							<div class="col-md-8">
						...
						<div class="form-group">
							<label class="col-md-3 control-label">Найменування галузі знань:<span
									style="color: red;">*</span></label>
							<div class="col-md-8">
						...
						<div class="form-group">
							<label class="col-md-3 control-label">Спеціальність:<span
									style="color: red;">*</span></label>
							<div class="col-md-8">
						...
						<div class="form-group">
							<label class="col-md-3 control-label">Освітньо-професійна програма:<span
									style="color: red;">*</span></label>
							<div class="col-md-8">
