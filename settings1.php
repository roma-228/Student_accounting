                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-bordered table-striped mb-none resp-tab">
                            ...
                            <tbody id="Table">
                                ...
                                <script>
                                    <?php
                                    $Student = $connect->query("SELECT t.`id_ group`, t.`name`,tn.`name` as 'nameSub',tn.`id_Subjects`,tn.`hour`,tn.`ESTS`,tn.`Teacher`,tn.`id_semestr` FROM `groups`t, `subjects`tn WHERE t.`id_kurse`=1 and t.`id_ group`=tn.`id_ group` ORDER BY `id_ group`");
                                    $num = 1;
